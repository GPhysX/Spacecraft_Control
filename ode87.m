function xout = ode87(spacecraft,tspan,x0)
% This file has been modified to allow the ode87 integration algorithm to work on the spacecraft and spacecraft_q
% classes. Below is the original description. All rights reserved to V.N.
% Govorukhin
%
...
%     component, anend;
%d plots the first component of the solution. 
%
% --------------------------------------------------------------------
...
% Compute the RHS for step of method
      ...
      for j = 1: 12
          f(:,j+1) = spacecraft.x_dotx(x+h*f*a_i_j(:,j));
      end;
